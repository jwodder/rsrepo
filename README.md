...
topic is added.  The custom labels used by the `.github/renovate.json5` file
generated by `rsrepo new` are created in the repository, a `CODECOV_TOKEN`
secret is set for GitHub Actions, automerging of PRs is enabled, and the tests
listed in the `.github/workflows/test.yml` file generated by `rsrepo new` are
registered as required checks for merging PRs.
